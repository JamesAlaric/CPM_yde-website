    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <div className="flex mx-auto border-2 border-seagull-500 rounded overflow-hidden mt-6">
            <button className="py-1 px-4 bg-seagull-500 text-white focus:outline-none">
              Présentiel
            </button>
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-seagull-500 flex flex-col relative overflow-hidden">
              ...
              <button className="flex items-center mt-auto text-white bg-seagull-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-seagull-600 rounded">
                Button
                <svg
                  fill="none"
                  stroke="currentColor"
